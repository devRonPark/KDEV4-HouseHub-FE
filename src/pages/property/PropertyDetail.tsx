      ...
      <div className="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div>
          <Card title="의뢰인">
            <div className="flex items-start">
              ...
              <div className="ml-3">
                ...
                <p className="text-sm text-gray-500">{property.customer.phone}</p>
          ...
          {property.contractList && property.contractList.length > 0 && (
            <Card title="계약 정보" className="mt-6">
              <div className="space-y-4">
                {property.contractList.map((contract) => (
                  ...
                  >
                    ...
                    {contract.contractType === 'JEONSE' && contract.deposit && (
                      <p className="text-gray-700 text-left">
                    ...
                    {contract.contractType === 'MONTHLY' && (
                      <>
                        ...
                        <p className="text-gray-700 text-left">
                          월세: {formatCurrency(contract.monthlyRent)}
                        </p>
                      </>
                    )}
                    {contract.startDate && contract.endDate && (
                      <p className="text-sm text-gray-500 mt-1 text-left">
                        계약기간: {formatDate(contract.startDate)} ~ {formatDate(contract.endDate)}
                      </p>
                    )}
                  </div>
                ))}
          ...
          {!property.contractList ||
            (property.contractList.length === 0 && (
              <Card title="계약 정보" className="mt-6">
