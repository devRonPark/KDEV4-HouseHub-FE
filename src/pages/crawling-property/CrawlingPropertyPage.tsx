                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center space-x-2">
                          <input
                            ...
                            onChange={(e) =>
                              handlePriceRangeChange('jeonse', 'min', e.target.value)
                            }
                            className="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                            placeholder="최소"
                          />
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              handlePriceRangeChange('jeonse', 'max', e.target.value)
                            }
                            className="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                            placeholder="최대"
                          />
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center space-x-2">
                          <input
                            ...
                            onChange={(e) =>
                              handlePriceRangeChange('deposit', 'min', e.target.value)
                            }
                            className="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                            placeholder="최소"
                          />
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              handlePriceRangeChange('deposit', 'max', e.target.value)
                            }
                            className="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                            placeholder="최대"
                          />
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center space-x-2">
                          <input
                            ...
                            onChange={(e) =>
                              handlePriceRangeChange('monthly', 'min', e.target.value)
                            }
                            className="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                            placeholder="최소"
                          />
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              handlePriceRangeChange('monthly', 'max', e.target.value)
                            }
                            className="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                            placeholder="최대"
                          />
                    ...
                    <div className="flex flex-row items-center justify-between">
                      <div>
                          ...
                          <span className="text-blue-600 font-semibold mr-2">
                            ...
                            {property.transactionType === 'MONTHLY' && (
                              <>
                                {' '}
                                {property.deposit?.toLocaleString()}/
                                {property.monthlyRentFee?.toLocaleString()}
                              </>
                            )}
                          </span>
                        ...
                        <p className="text-gray-600 font-semibold mr-2">
                          {propertyTypeKoreanMap[property.propertyType]} · {property.area}m² ·{' '}
                          {property.floor}/{property.allFloors}층 · {property.roomCnt}방 ·{' '}
...
export default CrawlingPropertyPage;
