...
const ConsultationForm = ({ customerId, initialData, onSubmit, onCancel }: ConsultationFormProps) => {
  const [selectedProperties, setSelectedProperties] = useState<Property[]>(initialData?.relatedProperties || [])
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-2">
                    ...
                    <div className="text-xs text-gray-500">
                      {property.type} | {property.location} | {property.size}평 | {property.price.toLocaleString()}만원
                    </div>
                  </div>
                </div>
              </div>
